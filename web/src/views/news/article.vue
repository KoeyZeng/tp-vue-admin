  ...
  <el-container class="container">
    <el-header class="header-box">
      <el-row :gutter="24" justify="space-between">
        <el-col :span="16">
          <el-input v-model="listQuery.title" class="filter-item w-200" placeholder="请输入文章标题" />
          ...
          <el-row :gutter="24" justify="space-between">
            <el-col :span="12">
              <el-form-item label="文章标题" prop="title">
                <el-input v-model="formData.title" class="w-90" placeholder="请输入文章标题" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item prop="url" label="文章URL">
                <el-input v-model="formData.url" class="w-90" placeholder="请输入文章URl" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item prop="path" label="封面图片">
                <upload-img :images="pathArr" :lengths="1" :put-file="'news'" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop="des" label="文章简介">
                <el-input v-model="formData.des" type="textarea" :rows="6" class="w-90" placeholder="请输入文章简介" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="24" justify="space-between">
...
<script>
import { getArticle, saveArticle, delArticle } from '@/api/news'
...
export default {
    ...
    return {
      ...
      rules: {
        title: [
          ...
          { min: 1, max: 100, message: '输入文章标题必须在1至100个字符内！', trigger: 'blur' }
        ],
        views: [
        ...
        url: [
          { min: 0, max: 250, message: '输入文章URl必须在0至250个字符内！', trigger: 'blur' }
        ],
        alt: [
        ...
        des: [
          ...
          { min: 1, max: 250, message: '输入文章简介必须在1至250个字符内！', trigger: 'blur' }
        ]
      },
      tableData: [],
  ...
  methods: {
    ...
    edit(row) {
      ...
      this.formData.formTitle = '编辑文章'
    },
    // 删除文章
    del() {
      if (this.multipleSelection.length === 0) {
        this.$message.error('请选择文章数据！')
        return false
      }
      const data = { id: [] }
