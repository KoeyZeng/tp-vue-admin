      ...
      >
        ...
        <el-table-column prop="sex" label="性别" width="60" align="center">
          <template slot-scope="{row}">
            <el-tooltip class="programPublish" :content="row.sex == '0'?'女': row.sex == '1'?'男': '保密' " placement="top">
              <i v-if="row.sex == '0'" class="icon-size el-icon-female" />
              <i v-else-if="row.sex == '1'" class="icon-size el-icon-male" />
              <i v-else class="icon-size el-icon-lock" />
            </el-tooltip>
          </template>
        </el-table-column>
      ...
      >
        <el-form ref="Form" :model="formData" label-width="130px" label-position="right">
          <el-row :gutter="24" justify="space-between">
            ...
            <el-col :span="12">
              <el-form-item prop="price" label="期望价格" class="el-form-height">
                <el-input v-model="formData.price" class="w-90">
            ...
            <el-col :span="24">
              <el-form-item prop="content" label="内容描述">
                <el-input v-model="formData.content" type="textarea" :rows="4" class="w-90" placeholder="请输入单位简介" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
<script>
import { getIndex, saveIndex, delIndex } from '@/api/consult'
    ...
    saveAudit() {
      this.$refs['auditForm'].validate((valid) => {
        if (valid) {
          ...
          saveIndex(this.auditData).then(res => {
